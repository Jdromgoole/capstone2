...
public class Musician implements Comparable<Musician> {
	...
	public Musician(String email, String name, String password) {
		super();
		this.email = email;
		this.name = name;
	...
	public Musician(String email, String name, UUID ID, String password) {
		super();
		this.email = email;
		this.name = name;
		this.ID = ID;
	...
	public Musician(String UUIDString, String name, String password, String email) {
		super();
		this.email = email;
		this.name = name;
